...
from _drgn import _linux_helper_load_btf, _linux_helper_load_orc
...
def load_btf(prog: Program) -> None:
    ...
    prog.register_object_finder("btf_hardcoded", btf_variable_finder, enable_index=-1)

    # ORC must come after the hardcoded BTF finder since it needs "modules" var
